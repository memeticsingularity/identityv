...
| [`design/`](design/) | 系统架构设计、数据模型规范、扩展指南 |
...
| 007 | [2025-04-19 氪金抽卡模拟器](dev/007-20250419-gacha-simulator.md) | 开发记录 | 回声充值、单池/多池抽卡、保底机制、概率公示、光效动画 |
| 008 | [2025-04-20 收藏图鉴、碎片系统与深渊珍宝](dev/008-20250420-collection-and-shards.md) | 开发记录 | 收藏册、碎片返还、首次获得弹窗、深渊珍宝Ⅰ~Ⅸ、内容说明弹窗 |
| DES-001 | [精华系统设计文档](design/essence-system-design.md) | 架构设计 | 数据模型、配置规范、运行时架构、抽卡引擎、扩展指南 |
